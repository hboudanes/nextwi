...
<div class="{{ $containerClass ?? 'mb-4' }}">
    ...
    <input 
        ...
        class="{{ $inputClass }}"
        {{ $attributes->except(['label', 'name', 'value', 'placeholder', 'required', 'disabled', 'readonly', 'pattern', 'autocomplete', 'autofocus', 'id', 'class', 'labelClass', 'containerClass', 'showErrors', 'helpText', 'maxlength']) }}
    />
