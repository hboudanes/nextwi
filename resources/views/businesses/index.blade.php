<x-main-layout>
    ...
    <main class="lg:ml-64 min-h-screen">
        <!-- Top Bar -->
        <x-top-bar title="Business Management" subtitle="Manage all registered businesses" routeName="businesses.create" class="bg-blue-600 text-white" buttonName="Add New Business">
