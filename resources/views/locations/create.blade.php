                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                ...
                                <div class="flex items-center gap-3">
                                    <input type="range" id="background-blur" name="background_blur" min="0"
                                        max="100" value="0" class="flex-1">
                                    <input type="number" id="background-blur-value" min="0" max="100"
                                        value="0"
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500 mt-1">Controls the opacity of the background overlay.
                                </p>
                            </div>
                            <div>
                                ...
                                <p class="text-xs text-gray-500 mt-1">Adjusts the contrast applied to the background.
                                </p>
                            </div>
                        </div>
